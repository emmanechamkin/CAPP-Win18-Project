...
def census_to_sql(year):
	...
	based on census data schema and available fields from years after 1990.
...
def old_census_to_sql(year):
	...
	based on census data schema and available fields from years before 1990.
...
#add median columns with missing data value fore years that do not contain 
#median variable (1960-1980)
